...
The `public contributions` and `private contributions` by users in Japan on `2022/6/28 3:10 PM UTC`. This list contains users from `Japan` and cities `Tokyo`.

There are `1 countries` and `1 cities` can be found [here](https://github.com/yusukebe/top-github-users-only-japan).

There are `1000 users`  in Japan. You need at least `130 followers` to be on this list.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/nzws">
				<img src="https://avatars.githubusercontent.com/u/14953122?s=72&u=013a162ac2b490a92e07fe5659f6ef40f7c8d4cb&v=4" width="24" alt="Avatar of nzws"> nzws
			</a><br/>
			Yuzuki Aida
		</td>
		<td>No Company</td>
